...
module ImageInfo
  class RequestHandler
    ...
    def build
      ::Typhoeus::Request.new(image.uri.to_s, followlocation: true, accept_encoding: :gzip, maxredirs: options[:redirect_limit], connecttimeout: options[:http_open_timeout], timeout: options[:http_read_timeout]).tap do |request|
