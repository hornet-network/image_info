...
module ImageInfo
  class Processor
    ...
    def initialize(urls, options = { max_concurrency: ::ImageInfo.config.max_concurrency, redirect_limit: ::ImageInfo.config.redirect_limit, http_open_timeout: ::ImageInfo.config.http_open_timeout, http_read_timeout: ::ImageInfo.config.http_read_timeout})
